...
#define RK3588_OVL_CTRL_FREEBSD_CLEAR		(BIT(0) | BIT(28) | \
						 GENMASK(31, 30))
#define RK3588_OVL_LAYER_SEL			0x604
#define RK3588_OVL_PORT_SEL			0x608
#define RK3588_OVL_LAYER_SEL_FREEBSD		0x76543210
#define RK3588_OVL_PORT_SEL_FREEBSD		0xa0507873
...
#define RK3588_CLUSTER_DLY_NUM_LINUX		0x00000404
...
#define RK3588_SMART_DLY_NUM_LINUX		0x17170000
				 ...
				 enum vop_modes mode, u32 port)
{
	...
	writel(RK3588_OVL_LAYER_SEL_FREEBSD,
	       priv->regs + RK3588_OVL_LAYER_SEL);
	writel(RK3588_OVL_PORT_SEL_FREEBSD,
	       priv->regs + RK3588_OVL_PORT_SEL);
	clrbits_le32(priv->regs + RK3588_OVL_CTRL,
		     RK3588_OVL_CTRL_FREEBSD_CLEAR);
...
static int rk3588_vop_initialize(struct udevice *dev)
{
	...
	writel(RK3588_CLUSTER_DLY_NUM_LINUX,
	...
	writel(RK3588_SMART_DLY_NUM_LINUX,
